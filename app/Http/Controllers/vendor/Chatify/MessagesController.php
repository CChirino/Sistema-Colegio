...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        // send the response
        return Response::json([
            'contacts' => $users->count() > 0 ? $contacts : '<br><p class="message-hint"><span>Lista de contactos esta vacia</span></p>',
        ], 200);
    }
    ...
    public function getFavorites(Request $request)
    {
        ...
        return Response::json([
            'favorites' => $favorites->count() > 0
                ? $favoritesList
                : '<p class="message-hint"><span>Tu lista de favoritos se encuentra vacia</span></p>',
        ], 200);
    }
    ...
    public function search(Request $request)
    {
        ...
        $records = User::where('nombre', 'LIKE', "%{$input}%");
    ...
    public function sharedPhotos(Request $request)
    {
        ...
        // send the response
        return Response::json([
            'shared' => count($shared) > 0 ? $sharedPhotos : '<p class="message-hint"><span>No se a compartido nada</span></p>',
        ], 200);
    }
