    ...
    <div class="content-error">
        <div class="hpanel">
            <div class="panel-body">
                    <form action="{{route('admin.update',$evaluaciones->id)}}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="date" id="fecha_fin"  class="form-control" value="{{$evaluaciones->fecha_inicio}}">
                                @error('fecha_fin')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
