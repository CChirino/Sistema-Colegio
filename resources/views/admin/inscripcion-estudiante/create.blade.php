...
<div class="content-error">
    <div class="hpanel">
        <div class="panel-body">
            <form method="POST" action="{{ route('inscripciones-estudiante.store') }}" id="loginForm" enctype="multipart/form-data" >
                @csrf
                <div class="row">
                    ...
                    <div class="form-group col-lg-12">
                        <label id="role_user_id" name="role_user_id" value="{{ $estudiantes->id }}" >{{ $estudiantes->nombre}} {{ $estudiantes->apellido}} </label>
                    </div>
