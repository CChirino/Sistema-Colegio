    ...
    <div class="content-error">
        ...
        <div class="hpanel">
            <div class="panel-body">
                    <form action="{{ route('opinion-evaluaciones.update',$opiniones->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <label>Opinion </label>
                            <textarea id="opinion"  class="form-control @error('opinion') is-invalid @enderror" name="opinion" required autocomplete="opinion" autofocus  rows="3">{{$opiniones->opinion}}</textarea>
                                @error('opinion')
