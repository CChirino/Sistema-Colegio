                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                {{-- <li><a href=""> {{ $listarevaluaciones ->nombre}} {{ $listarevaluaciones ->apellido}} {{ $listarevaluaciones ->nombre_materia}} {{ $listarevaluaciones ->nombre_evaluacion}}</a></li> --}}
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body">
                    <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control" name="subir_evaluaciones_id" id="subir_evaluaciones_id"  disabled>        
                                    ...
                                    <option value="{{$opiniones->subir_evaluaciones_id}}"> 
                                        ...
                                        {{ $le ->nombre_materia}} - {{ $le ->nombre_evaluacion}}                        
                                    </option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <label>Opinion </label>
                            <textarea id="opinion"  class="form-control @error('opinion') is-invalid @enderror" name="opinion" required autocomplete="opinion" autofocus  rows="3" disabled>{{$opiniones->opinion}}</textarea>
                                @error('opinion')
                            ...
                            <div class="col-lg-12">
                                <div class="text-center">
                                    <a href="{{ route('opinion-evaluaciones-estudiantes.index')}}" class="btn btn-success loginbtn"> Regresar</a>
                                </div>
                            </div>
                        </div>
                    </form>
