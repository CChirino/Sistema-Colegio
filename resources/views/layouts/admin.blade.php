  ...
  <div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="index.html"><img class="main-logo" src="{{ asset('asset/img/logo/logo.png')}}" alt="" /></a>
                ...
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="All Professors" href="{{route('colegio.index')}}"><span class="mini-sub-pro">Colegio</span></a></li>
                            <li><a title="Add Professor" href="{{route('coordinador.index')}}"><span class="mini-sub-pro">Coordinador</span></a></li>
                            <li><a title="Edit Professor" href="{{route('estudiante.index')}}"><span class="mini-sub-pro">Estudiantes</span></a></li>
                            <li><a title="Professor Profile" href="{{route('profesor.index')}}"><span class="mini-sub-pro">Profesores</span></a></li>
                        </ul>
                    </li>
                    {{-- <li>
                    ...
                    <li>
                        <a class="has-arrow" href="all-courses.html" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span> <span class="mini-click-non">Materias</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                                        ...
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu navbar-expand-lg">
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                        ...
                                                        {{-- <span class="admin-name">{{ auth()->user()->nombre }} {{ auth()->user()->apellido }}</span> --}}
