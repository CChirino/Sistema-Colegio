...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-body">
           ...
           <div class="messenger-tab app-scroll" data-view="search">
                ...
                <div class="search-records">Buscar
                    <p class="message-hint"><span>Busca un usuario</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="internet-connection">
            ...
            <span class="ic-noInternet">No tiene acceso a internet</span>
        </div>
        {{-- Messaging area --}}
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span>Por favor selecciones un chat para empezar hablar</span></p>
            </div>
            {{-- Typing indicator --}}
